...
## Branch Integration: claude/inspect-and-report-9kFd9 (COMPLETED)

- [x] Import SOFA vasopressor-based cardiovascular scoring
- [x] Update SOFA calculator definition with vasopressor inputs
- [x] Import MELD value clamping and dialysis support
- [x] Update MELD calculator definition with dialysis checkbox
- [x] Restore HAS-BLED calculator (deleted in branch)
- [x] Import enhanced documentation for all calculators
- [x] Import HEART, RCRI, SMART-COP, FIB-4, GCS fixes
